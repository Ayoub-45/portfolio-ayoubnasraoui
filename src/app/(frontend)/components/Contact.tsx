...
import ContactCards from "./ContactCards"; // 👈 Import our new client wrapper here
  ...
  return (
    <section id="contact" className="px-8 md:px-16 py-24 max-w-6xl mx-auto text-center">
      <FadeUp>
        ...
        {/* 👈 Mount all interactive anchor logic inside our Client abstraction */}
...
// Global SVG Icons mapping setups
function EmailIcon() {
  return (
